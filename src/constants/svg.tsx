    ...
    >
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 56 64" xmlSpace="preserve" fill="#000">
            <g fill="none" stroke="#6B6C6E" strokeWidth={2}>
                ...
                <g>
                    <path
                        d="M42 14.1V52c0 1.1-.9 2-2 2H2c-1.1 0-2-.9-2-2V2C0 .9.9 0 2 0h23.9L42 14.1h0z"
                        transform="translate(1 1) translate(12)"
                    />
                    <path
                        d="M42 14.9H28c-1.1 0-2-.9-2-2V1M7 13h13M7 22h28M7 29h28M7 38h28M7 44h28"
                        transform="translate(1 1) translate(12)"
                    />
                </g>
            </g>
