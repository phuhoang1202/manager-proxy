...
const SignUp: React.FC = () => {
    ...
    const onSubmit: SubmitHandler<FormFields> = async (formFields: FormFields) => {
        // logic validate value register
        const { confirmPassword, ...data } = formFields;
        const createUser = { ...data, status: true, image: '', subUser: '' };
        // logic call api register
        try {
            const result = await axiosClient.post('/users', createUser);
                        ...
                        <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
                            ...
                            <form onSubmit={handleSubmit(onSubmit)}>
                                ...
                                <div className="mb-4">
                                    ...
                                    <div className="relative">
                                        <input
                                            id='username'
                                            type="text"
                                            placeholder="Tên tài khoản là bắt buộc"
                                            {...register('username')}
                                            className="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 text-black outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                                        />
                                        <span className="absolute right-4 top-4">
                                ...
                                <div className="mb-4">
                                    ...
                                    <div className="relative">
                                        <input
                                            id='password'
                                            type="password"
                                            placeholder="Mật khẩu ít nhất 8 ký tự, 1 chữ hoa, thường, số và 1 ký tự đặc biệt !@#$%^&*()"
                                            {...register('password')}
                                            className="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 text-black outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                                        />
                                        <span className="absolute right-4 top-4">
                                ...
                                <button type='submit' disabled={!isDirty || !isValid || isSubmitting}
                                    className={`w-full  rounded-lg border border-primary bg-primary p-4 text-white transition hover:bg-opacity-90 ${(!isDirty || !isValid || isSubmitting) ? 'cursor-not-allowed' : 'cursor-pointer'}`}
                                >
                                    Đăng ký
                                </button>
