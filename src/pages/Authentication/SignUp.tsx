...
import { UserSvg, ContactSvg, UnlockSvg, LockSvg } from '../../constants/svg';
...
export const registerSchema = z.object({
    ...
    password: z.string()
        ...
        .regex(CONSTANT.PATTERN.PASSWORD, "Mật khẩu phải chứa ít nhất 1 chữ hoa, 1 chữ thường, 1 số và 1 ký tự đặc biệt từ !@#$%^&*()"),
                            ...
                            <form onSubmit={handleSubmit(onSubmit)}>
                                ...
                                <div className="mb-4">
                                    ...
                                    <div className="relative">
                                        <input
                                            ...
                                            className="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 text-black outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                                        />
                                        <span className="absolute right-4 top-4 cursor-pointer" onClick={onToggleShowPassword}>
                                ...
                                <button
                                    ...
                                    className={`w-full rounded-lg border border-primary bg-primary p-4 text-white transition hover:bg-opacity-90 flex items-center justify-center
                                        ${(!isDirty || !isValid || isSubmitting) ? 'cursor-not-allowed' : 'cursor-pointer'}`}
                                >
                                    {isSubmitting ? (
