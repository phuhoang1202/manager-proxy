    ...
    const onSubmit: SubmitHandler<FormFields> = async (formFields: FormFields) => {
        ...
        try {
            ...
            if (result.status === 200) {
                const userFind: any = result.data.find((user: any) => user.email === formFields.email && user.password === formFields.password);

                if (userFind && userFind.id) {
                    const { password, ...userLogin } = userFind;
                    localStorage.setItem(CONSTANT.USERLOGIN, JSON.stringify(userLogin));
                    ...
                    <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
                        <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
                            ...
                            <form className='mt-9' onSubmit={handleSubmit(onSubmit)}>
                                ...
                                <button type='submit' className={`w-full  rounded-lg border border-primary bg-primary p-4 text-white transition hover:bg-opacity-90
